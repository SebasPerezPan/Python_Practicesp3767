...
print(f"El costo total de los investigadores es de $ {invest_total}. ")
...
print(f"El costo total de los asistentes es de $ {assist_total}. ")
...
trip_total = int((tripq*tripp*(triph)+tripp*tripd*trip_days))
...
print(f"El subtotal de la investigacion es ${subtotal}, los costos administrativos seran de ${admin}, para un total de ${subtotala}, y teniendo en cuenta el iva un total ${subtotalb}")
